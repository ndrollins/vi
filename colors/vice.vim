" File:       Passionfuit.vim
" Maintainer: Nathaniel Rollins
" URL:        https://github.com/fielding/vice ORIGINAL
" License:    MIT
"
...
" let s:violet      = { 'gui': '#8a2be2', 'cterm': '5' }
" let s:magenta     = { 'gui': '#ff00ff', 'cterm': '13' }
" let s:red         = { 'gui': '#ff0000', 'cterm': '1' }
" let s:orange      = { 'gui': '#FC7531', 'cterm': '9' }
" let s:yellow      = { 'gui': '#ffff00', 'cterm': '15' }
" let s:green       = { 'gui': '#00ff00', 'cterm': '10' }

"45 degree space
" let s:cyan        = { 'gui': '#31FCDA', 'cterm': '11' }
" let s:blue        = { 'gui': '#3186FC', 'cterm': '4' }
" let s:violet      = { 'gui': '#8a2be2', 'cterm': '5' }
" let s:magenta     = { 'gui': '#ff00ff', 'cterm': '13' }
" let s:red         = { 'gui': '#ff0000', 'cterm': '1' }
" let s:orange      = { 'gui': '#FCA731', 'cterm': '9' }
" let s:yellow      = { 'gui': '#ffff00', 'cterm': '3' }
" let s:green       = { 'gui': '#00ff00', 'cterm': '2' }
...
let s:darkred     = { 'gui': '#ff0000', 'cterm': '52' }
...
" editor
call s:h("Normal",        { "fg": s:magenta,      "bg": s:black })
...
call s:h("SpellBad",      { "fg": s:magenta,        "bg": s:black })
call s:h("SpellCap",      { "fg": s:orange,     "bg": s:black })

" misc
call s:h("SpecialKey",    { "fg": s:orange })
